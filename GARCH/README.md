...
| Model4 | GPR_zscore + VIX + Fear&Greed |
| Model5 | GPR_custom + VIX + Fear&Greed |

## EGARCH-X

| 모델        | 외생변수                          |
| --------- | ----------------------------- |
| EGARCH_E1 | GPR_custom                    |
| EGARCH_E2 | GPR_zscore                    |
| EGARCH_E3 | VIX + Fear&Greed              |
| EGARCH_E4 | GPR_custom + VIX + Fear&Greed |
| EGARCH_E5 | ΔGPR + VIX + Fear&Greed       |
| EGARCH_E6 | GPR Dummy + VIX + Fear&Greed  |

---

# 7. 분석 방법론 (Methodology)
